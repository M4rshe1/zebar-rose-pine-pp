...
function Media() {
  ...
  providers.onOutput((map) => setMedia(map.media));
  ...
  return (
    <Show when={media()}>
      ...
      >
        <Switch>
          <Match when={media()!.currentSession.isPlaying}>
        ...
        <div class="flex items-center gap-2 group-hover:translate-y-6 group-hover:opacity-0 transition-all duration-300">
          <div class="flex items-center gap-1">
            <span class="text-sm">{media()!.currentSession.artist}</span>
            <span class="text-sm">-</span>
            <span class="text-sm">
              {media()!.currentSession.title.slice(0, 25).trim() +
                (media()!.currentSession.title.length > 25 ? "..." : "")}
            </span>
          </div>
          ...
          <div class="flex flex-1 w-full h-full text-lg items-center gap-1 justify-between">
            ...
            <button
              ...
              class={cn(
                ...
                {
                  hidden: !media()!.currentSession.isPlaying,
